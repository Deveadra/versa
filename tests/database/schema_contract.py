...
REQUIRED_TABLES: dict[str, set[str]] = {
    ...
    "usage_log": {
        "id", "user_text", "normalized_intent", "resolved_action",
        "params_json", "success", "latency_ms", "created_at"
    },
    ...
    "context_signals": {
        "id", "name", "value", "type", "description", "confidence", "source", "last_updated"
    },
    "derived_signals": {"id", "name", "definition", "created_at"},
    "engagement_rules": {
        "id", "name", "enabled", "topic_id", "priority", "reset_signals",
        "cooldown_seconds", "max_per_day", "condition_json", "tone_strategy_json",
        "context_template", "created_at", "updated_at"
    },
    ...
    "tone_memory": {
        "id", "topic_id", "tone", "ignored_count", "acted_count",
        "consequence_note", "last_updated", "last_tone", "last_outcome", "updated_at"
    },
    ...
    "proposed_rules": {
        "id", "name", "topic_id", "priority", "cooldown_seconds", "max_per_day",
        "condition_json", "tone_strategy_json", "context_template", "confidence",
        "score", "status", "rationale", "created_at", "approved_at", "denied_at",
